require File.join(File.dirname(__FILE__), '..', 'models', 'product')
require File.join(File.dirname(__FILE__), '..', 'models', 'purchase')
require File.join(File.dirname(__FILE__), '..', 'models', 'store')
require File.join(File.dirname(__FILE__), '..', 'models', 'employees')
require 'rubygems'
require 'yaml'
